...
{
    public abstract class BaseForgeLevelProvider : BaseForgeAsset, ILevelProvider
    {
        ...
        public abstract bool LinkToProvider(BaseForgeLevelProvider provider);
        public abstract bool IsLinkedTo(ScriptableObject provider);
        public abstract bool IsLinked { get; }
        public abstract BaseForgeLevelProvider LinkedProvider { get; set; }
        ...
        /// <returns></returns>
        public bool HasCircularDependency(BaseForgeLevelProvider linkTo, out BaseForgeLevelProvider issue, out string chain)
        {
            issue = null;
            chain = "";
            ...
            bool CheckRecursive(BaseForgeLevelProvider curr, out BaseForgeLevelProvider _issue)
            {
                if (curr.IsLinked)
                {
