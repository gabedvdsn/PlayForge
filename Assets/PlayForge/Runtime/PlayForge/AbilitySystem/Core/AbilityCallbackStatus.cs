...
namespace FarEmerald.PlayForge
{
    public struct AbilityCallbackStatus
    {
        ...
        private AbilityCallbackStatus(AbilityDataPacket data, List<AbstractProxyTask> tasks, AbilityProxyStage stage, Tag injection, bool success)
        {
            Data = data;
            Tasks = tasks;
            Stage = stage;
        ...
        {
            return new AbilityCallbackStatus(data, new List<AbstractProxyTask>(){ task }, stage, Tags.NULL, completed);
        }
