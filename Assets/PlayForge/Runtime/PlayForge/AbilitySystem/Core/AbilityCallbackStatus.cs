namespace FarEmerald.PlayForge
{
    public struct AbilityCallbackStatus
    {
        ...
        public AbstractProxyTask Task => Tasks?.Length > 0 ? Tasks[0] : null;

        private AbilityCallbackStatus(AbilityDataPacket data, AbstractProxyTask[] tasks, AbilityProxyStage stage, Tag injection, bool success)
        {
            Data = data;
            Tasks = tasks;
            Stage = stage;
        ...
        {
            return new AbilityCallbackStatus(data, new[] { task }, stage, Tags.NULL, completed);
        }
        ...
        {
            return new AbilityCallbackStatus(data, stage.Tasks, stage, Tags.NULL, success);
        }
        ...
        {
            return new AbilityCallbackStatus(data, null, null, Tags.NULL, true);
        }
        ...
        /// <returns></returns>
        public static AbilityCallbackStatus GenerateForInjection(AbilityDataPacket data, AbilityProxyStage stage, Tag injection, bool injectionSuccessful)
        {
