...
{
    /// <summary>
    /// Custom property drawer for AbstractScalerBehaviour that provides a type picker dropdown
    /// and displays the serialized fields of each concrete implementation.
    /// </summary>
    ...
    public class ScalerBehaviourDrawer : AbstractTypeRefDrawer<AbstractScalerBehaviour>
    {
        ...
        protected override string GetStringValue(SerializedProperty prop, Type value)
        {
            ...
            var name = value.Name;
            name = name.Replace("ScalerBehaviour", "");
