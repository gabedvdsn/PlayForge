...
namespace FarEmerald.PlayForge.Extended.Editor
{
    public partial class TheForge
    {
        ...
        private void BuildGeneralSettingsTab()
        {
            ...
            var tagStatsLabel = new Label($"Unique Tags: {ForgeTagRegistry.GetAllTags().Count()}\nContexts: {ForgeTagRegistry.GetAllContextKeys().Count()}\nLast Scan: {(ForgeTagRegistry.IsCacheValid ? ForgeTagRegistry.LastScanTime.ToString("HH:mm:ss") : "Never")}");
